...
const CartPage = () => {
  ...
  return (
    <div className="flex flex-col gap-8 items-center justify-center mt-12">
        {/* title */}
        <h1 className="text-2xl font-meidum">Your Shopping Cart</h1>
        {/* steps */}
        ...
        <div className="w-full flex flex-col lg:flex-row gap-16">
            ...
            <div className="w-full lg:w-7/12 shadow-lg border-1 border-gray-100 p-8 rounded-lg flex flex-col gap-8">
                ...
                : activeStep === 2 ? <ShippingForm setShippingForm={setShippingForm}/> : activeStep===3 && shippingForm ? <PaymentForm/> : <p className="text-gray-500">Please fill in the shipping form to continue</p>}
            </div >
            {/* details  */}
